...
// 28 Column Exact Clean Thumbnails Config
const thumbnailConfigs = {
  ...
  'acute-stiff-neck-nakchim': {
    category: '척추·관절 & 추나 클리닉',
    subHook: '자고 일어났을 때 목이 안 돌아가는 급성 관절 잠김',
    title: '급성 낙침(落枕) · 목 결림 한방 치료',
    step1: { title: '경추 후관절낭 감돈 & 근육 연축 체크', desc: '목 디스크 급성 방사통과의 정밀 감별 진단' },
    step2: { title: '즉각 가동성 회복 동작침법 (MSAT)', desc: '침을 맞고 고개를 돌려 5분 만에 잠김 해제' },
    step3: { title: '경추 관절 가동 추나 & 소염약침', desc: 'C커브 정상화 및 후관절 활액막염 진정' }
  },
